...
for idx,row in enumerate(contents_row):
    ...
    real_contents_status =  db.select('crawling_status_navershopping_view','*','contents_id="%s"'%(contents_id))
    ...
    if real_contents_status=='GR' and n_reply>0:
            ...
            db.update_one('crawl_contents','crawl_status','GR','contents_id',contents_id)
