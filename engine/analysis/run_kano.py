...
print(df_2016['pos_num'],df_2016['neg_num'])
print(df_2017['pos_num'],df_2017['neg_num'])
print(df_total)
...
kano_df = kano.get_kanoXY(kano_df)
kano_df.to_csv('{}/{}_{}_{}_{}.csv'.format(xy_path,keyword, channel, fromdate, todate))
print(kano_df)
plt = kano.visualize_df_kano(kano_df)
plt.savefig('{}/{}_{}_{}_{}'.format(img_path,keyword, channel, fromdate, todate))