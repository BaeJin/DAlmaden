...
startDate3 = '2019-01-01'
endDate3 = '2020-02-011'
...
plt.axis('off')
plt.savefig('image/inter/'+keyword1+startDate1+endDate1+'_inter_'+keyword1+startDate2+endDate2+'_inter_'+keyword1+startDate3+endDate3+".png",transparent = True)
