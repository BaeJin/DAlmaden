...
#     nvMid_dict = {}
#     db = Sql('salmaden', hostIP='106.246.169.202', port=3306 , userID='root', password='robot369')
#     start_productID = REVIEW_START_PRODUCT_ID
#     start_page = REVIEW_START_PAGE
#
#     def start_requests(self):
#         ids = self.db.select('product','id, site_productID', f"channel = 'navershopping' and category= '{CATEGORY}'")
#
#         for id in ids:
