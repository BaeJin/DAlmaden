...
#                     page_info_original = soup.find_all('script', {'type': 'text/javascript'})
#
...
#                     print('page_info_original:',page_info_original)
#                     #
#                     # ##original product no 가져오기 위한 데이터 전처리 process
#                     # try:
#                     #     page_info_original_pick = str(page_info_original[-1])
#                     #     print("page_info_original_pick:", page_info_original_pick)
#                     #     page_info_original_pick = page_info_original_pick.split(
#                     #         "nmp.registerModule(nmp.front.sellershop.product.review.photo.store, ")[1]
#                     #     page_info_original_pick = page_info_original_pick.split(");")[0]
#                     #     page_info_original_pick = page_info_original_pick.replace("\n    ", "")
#                     #     page_info_original_pick = json.loads(page_info_original_pick)
#                     #     originalProductNo = page_info_original_pick['originalProductNo'] if len(
#                     #         page_info_original_pick['originalProductNo']) > 0 else 0
#                     #     newProductNo = page_referer_url.split("/")[-1]
#                     #     if not ((originalProductNo == newProductNo) or (originalProductNo == 0)):
#                     #         original_page_referer_url = page_referer_url.split("/")[0:-1]
#                     #         original_page_referer_url.append(originalProductNo)
#                     #         original_page_referer_url = '/'.join(original_page_referer_url)
#                     #
#                     # except Exception as e:
#                     #     print(e, 'no page_info_original')
#                     #     original_page_referer_url = page_referer_url
#
#                 except Exception as e:
#                     print(e)
...
#                     review_page_url = 'https://smartstore.naver.com/i/v1/reviews/paged-reviews?page={}&pageSize=20&originProductNo={}&sortType=REVIEW_RANKING'.\
#                         format(page, newProductNo)
#                     # review_page_url = '{}/reviews/page.json?page={}&size=20&sortType=REVIEW_RANKING&contentType=ALL&topicCode='.format(
#                     #     nvMid, page)
