...
def analyaze_tweets(keyword,loc,since,until):
    df_coord = pd.DataFrame(itertools.islice(sntwitter.TwitterSearchScraper(
        '{} near:"{}" since:{} until:{}'.format(keyword,loc,since,until)).get_items(), 5000))[['user', 'date','content']]
...
# coordA = '34.052235, -118.243683, 100km'
# coordB = '37.773972, -122.431297, 100km'
...
dict_wordA,len_df_A = analyaze_tweets(keyword,locA,sinceA,untilA)
dict_wordB,len_df_B = analyaze_tweets(keyword,locB,sinceB,untilB)
